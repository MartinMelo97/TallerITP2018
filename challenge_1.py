...
#Importamos la librería math para utilizar sqrt
import math

# Recibimos los 2 números
# Recordemos que al utilizar "Input" lo que reciba del teclado será de tipo string
...
# Comenzamos a realizar las operaciones solicitadas, almacenando
# cada una en una variable diferente
suma = num1 + num2
resta = num1 - num2
...
suma_raices = math.sqrt(num1) + math.sqrt(num2)
...
print("La suma de raíces es:", suma_raices)
